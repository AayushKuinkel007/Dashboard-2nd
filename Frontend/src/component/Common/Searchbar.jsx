        ...
        <div className="col-md-4 d-flex align-items-center justify-content-center">
          <div className="input-group w-100">
            <input
              ...
              placeholder="Search..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)} // ⬅️ Update search term
            />
        ...
        <div className="col-md-4 d-flex justify-content-end align-items-center">
          <Link to="/cart" className="text-dark position-relative me-3">
            ...
            >
              ...
              <path
                d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 
              0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 
              0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zm3.915 
              10L3.102 4h10.796l-1.313 7zM6 14a1 1 0 1 1-2 0 
              1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0"
              />
            </svg>
            {cartSum > 0 && (
